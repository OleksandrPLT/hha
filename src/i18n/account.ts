...
export const account: Record<Locale, AccountCopy> = {
	en: {
		...
		editProfile: {
			...
			linkedSuccess: 'Your Google account is now connected.',
			unlinkedSuccess: 'Google account disconnected.',
	...
	et: {
		...
		editProfile: {
			...
			linkedSuccess: 'Sinu Google konto on nüüd ühendatud.',
			unlinkedSuccess: 'Google konto ühendus katkestatud.',
	...
	uk: {
		...
		editProfile: {
			...
			linkedSuccess: 'Ваш Google-акаунт підключено.',
			unlinkedSuccess: 'Google-акаунт відключено.',
	...
	ru: {
		...
		editProfile: {
			...
			linkedSuccess: 'Ваш Google-аккаунт подключён.',
			unlinkedSuccess: 'Google-аккаунт отключён.',
	...
	lv: {
		...
		editProfile: {
			...
			linkedSuccess: 'Jūsu Google konts ir pievienots.',
			unlinkedSuccess: 'Google konts atvienots.',
		...
		editProfile: {
			...
			linkedSuccess: 'Google-tilisi on nyt yhdistetty.',
			unlinkedSuccess: 'Google-tili irrotettu.',
